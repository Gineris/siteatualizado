...
// 0 não tem solicitação ou está aguradando aprovação
// 1 não tem permissão pra atualizar
// 2 tem permissõa para atualizar
if($permissao == 0){
    echo 'Não tem solicitação';
}else if($permissao == 1){
    echo 'Adm não permitiu atualização';
}else{
    echo 'atualixado';
